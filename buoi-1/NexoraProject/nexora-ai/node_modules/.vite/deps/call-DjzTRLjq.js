import { B as InvalidBytesLengthError, C as toBytes, D as stringToHex, E as numberToHex, F as trim$2, G as isHex, H as InvalidAddressError, I as IntegerOutOfRangeError$1, L as InvalidBytesBooleanError$1, N as hexToNumber, T as bytesToHex, U as BaseError$2, V as SliceOffsetOutOfBoundsError$2, W as size$2, _ as isAddress, f as isAbortError, h as checksumAddress, j as hexToBigInt, k as assertSize$2, l as getAbortError, m as parseAccount, p as stringify$1, t as createBatchScheduler, u as getContractAddress, w as boolToHex, x as hexToBytes, y as keccak256, z as padHex } from "./createBatchScheduler-BfmwkS-o.js";
import { d as equalBytes } from "./utils-DC3OA5hP.js";
...
function encodeString(value) {
	...
	return {
		dynamic: true,
		encoded: concatHex([padHex(numberToHex(size$2(hexValue), { size: 32 })), ...parts])
	};
}
...
var docsPath$2 = "/docs/contract/decodeFunctionResult";
function decodeFunctionResult(parameters) {
	...
	if (!abiItem.outputs) throw new AbiFunctionOutputsNotFoundError(abiItem.name, { docsPath: docsPath$2 });
...
var docsPath$1 = "/docs/contract/encodeFunctionData";
...
async function call(client, args) {
	...
	try {
		...
		const { offchainLookup, offchainLookupSignature } = await import("./ccip-DHq6apvZ.js");
...
//#endregion
export { trimLeft$1 as $, AbiDecodingZeroDataError as $t, fromNumber as A, toFunctionSelector as At, trimLeft as B, formatAbiItem as Bt, IntegerOutOfRangeError as C, getChainContractAddress as Ct, from as D, encodeFunctionData as Dt, concat as E, InvalidChainIdError as Et, size as F, splitParameters as Ft, fromString$1 as G, integerRegex$1 as Gt, concat$1 as H, decodeAbiParameters as Ht, slice as I, InvalidAbiParametersError as It, slice$1 as J, slice$2 as Jt, isEqual as K, concat$2 as Kt, toBigInt as L, InvalidAbiItemError as Lt, padLeft as M, parseStructs as Mt, padRight as N, parseAbiParameter as Nt, fromBoolean as O, decodeFunctionResult as Ot, random as P, parseSignature as Pt, toString$1 as Q, AbiDecodingDataSizeTooSmallError as Qt, toNumber as R, isStructSignature as Rt, toRpc as S, solidityError as St, assert as T, ChainNotFoundError as Tt, from$1 as U, encodeAbiParameters as Ut, validate as V, formatAbiParameters as Vt, fromHex as W, bytesRegex$1 as Wt, toBoolean as X, createCursor as Xt, toBigInt$1 as Y, sliceHex as Yt, toNumber$1 as Z, PositionOutOfBoundsError as Zt, isAddressEqual as _, erc6492SignatureValidatorAbi as _n, formatGwei as _t, serializeStateOverride as a, AbiFunctionNotFoundError as an, ContractFunctionRevertedError as at, erc6492SignatureValidatorByteCode as b, universalResolverResolveAbi as bn, from$2 as bt, defineFormatter as c, BytesSizeMismatchError as cn, InvalidLegacyVError as ct, getNodeError as d, InvalidArrayError as dn, TransactionExecutionError as dt, AbiErrorInputsNotFoundError as en, validate$1 as et, ExecutionRevertedError as f, formatAbiItem$1 as fn, TransactionNotFoundError as ft, formatBlockParameter as g, erc20Abi as gn, prettyPrint as gt, UnknownNodeError as h, erc1271Abi as hn, WaitForTransactionReceiptTimeoutError as ht, maxUint256 as i, AbiEventSignatureNotFoundError as in, ContractFunctionExecutionError as it, fromString as j, toEventSelector as jt, fromBytes as k, getAbiItem as kt, extract as l, DecodeLogDataMismatch as ln, InvalidSerializableTransactionError as lt, TipAboveFeeCapError as m, batchGatewayAbi as mn, TransactionReceiptRevertedError as mt, assertRequest as n, AbiEventNotFoundError as nn, BaseError as nt, defineTransactionRequest as o, AbiFunctionOutputsNotFoundError as on, ContractFunctionZeroDataError as ot, FeeCapTooHighError as p, addressResolverAbi as pn, TransactionReceiptNotFoundError as pt, size$1 as q, concatHex as qt, maxUint16 as r, AbiEventSignatureEmptyTopicsError as rn, CallExecutionError as rt, formatTransactionRequest as s, AbiFunctionSignatureNotFoundError as sn, RawContractError as st, call as t, AbiErrorNotFoundError as tn, stringify as tt, getCallError as u, DecodeLogTopicsMismatch as un, InvalidStorageKeySizeError as ut, encodeDeployData as v, multicall3Abi as vn, formatEther as vt, InvalidLengthError as w, ChainMismatchError as wt, multicall3Bytecode as x, universalResolverReverseAbi as xn, decodeErrorResult as xt, deploylessCallViaBytecodeBytecode as y, textResolverAbi as yn, format as yt, toString as z, modifiers as zt };
