...
import { C as useQueryClient, et as replaceEqualDeep, h as useQuery$1, r as useMutation, t as useInfiniteQuery$1 } from "./modern-BKQGmk3w.js";
import { $t as AbiDecodingZeroDataError, Ct as getChainContractAddress, Dt as encodeFunctionData, E as concat$1, Gt as integerRegex, Jt as slice, Kt as concat, Ot as decodeFunctionResult, S as toRpc, Ut as encodeAbiParameters, Wt as bytesRegex, Yt as sliceHex, _ as isAddressEqual, a as serializeStateOverride, at as ContractFunctionRevertedError, bn as universalResolverResolveAbi, bt as from$2, cn as BytesSizeMismatchError, d as getNodeError, f as ExecutionRevertedError, fn as formatAbiItem, ft as TransactionNotFoundError, g as formatBlockParameter, gn as erc20Abi, h as UnknownNodeError, ht as WaitForTransactionReceiptTimeoutError, it as ContractFunctionExecutionError, jt as toEventSelector, kt as getAbiItem, l as extract, ln as DecodeLogDataMismatch, mt as TransactionReceiptRevertedError, n as assertRequest, nn as AbiEventNotFoundError, pn as addressResolverAbi, pt as TransactionReceiptNotFoundError, s as formatTransactionRequest, st as RawContractError, t as call$1, u as getCallError, un as DecodeLogTopicsMismatch, v as encodeDeployData, vn as multicall3Abi, x as multicall3Bytecode, xn as universalResolverReverseAbi, y as deploylessCallViaBytecodeBytecode, yn as textResolverAbi, yt as format } from "./call-DjzTRLjq.js";
import { C as toBytes, D as stringToHex, E as numberToHex, F as trim, G as isHex, H as InvalidAddressError, N as hexToNumber, O as toHex, P as hexToString, S as stringToBytes, T as bytesToHex, U as BaseError$1, W as size$1, _ as isAddress, a as RpcRequestError, g as getAddress, h as checksumAddress, j as hexToBigInt, m as parseAccount, n as withResolvers, p as stringify, t as createBatchScheduler, v as LruMap, y as keccak256 } from "./createBatchScheduler-BfmwkS-o.js";
import { B as decodeEventLog, C as encode$1, G as formatLog, J as prepareTransactionRequest$1, K as estimateGas$1, R as assertCurrentChain, U as formatTransactionReceipt, V as getCode, W as receiptStatuses, X as getChainId$1, Y as fillTransaction, Z as getTransactionError, _t as recoverAuthorizationAddress, a as AccountTypeNotSupportedError, bt as getContractError, c as from$3, ct as estimateFeesPerGas$1, dt as getBlock$1, gt as BlockNotFoundError, ht as formatTransaction, i as AccountNotFoundError, l as fromAbi$2, lt as estimateMaxPriorityFeePerGas$1, n as sendTransaction$1, o as verifyHash, pt as formatBlock, q as defaultParameters, r as sendRawTransaction, s as NotFoundError, st as getTransactionCount$1, t as writeContract$1, u as getSelector$1, ut as getGasPrice$1, xt as getAction$1, yt as readContract$1, z as parseEventLogs } from "./writeContract-CEJCl1Tq.js";
import "./localBatchGatewayRequest-CWneCGgi.js";
import { D as WalletConnectSessionSettlementError, E as UserRejectedRequestError, h as ProviderDisconnectedError, i as ChainDisconnectedError, n as AtomicityNotSupportedError, s as InvalidInputRpcError, w as UnsupportedNonOptionalCapabilityError, y as TransactionRejectedRpcError } from "./rpc-n6Pd07Gw.js";
import { C as wait, S as withRetry, _ as version$1, a as SwitchChainNotSupportedError, b as getHttpRpcClient, c as uid$1, d as ConnectorAlreadyConnectedError, f as ConnectorChainMismatchError, g as BaseError$2, h as ConnectorUnavailableReconnectingError, i as ProviderNotFoundError, l as ChainNotConfiguredError, m as ConnectorNotFoundError, n as injected, o as custom, p as ConnectorNotConnectedError, r as createConnector, s as createTransport, t as mock, u as ConnectorAccountNotFoundError, v as getSocket, x as withTimeout, y as getWebSocketRpcClient } from "./mock-C-DUvc-X.js";
//#region node_modules/viem/_esm/utils/ens/errors.js
function isNullUniversalResolverError(err) {
	if (!(err instanceof BaseError$1)) return false;
...
var EnsAvatarInvalidMetadataError = class extends BaseError$1 {
	constructor({ data }) {
...
var EnsAvatarInvalidNftUriError = class extends BaseError$1 {
	constructor({ reason }) {
		super(`ENS NFT avatar URI is invalid. ${reason}`, { name: "EnsAvatarInvalidNftUriError" });
	}
};
var EnsAvatarUriResolutionError = class extends BaseError$1 {
	constructor({ uri }) {
		super(`Unable to resolve ENS avatar URI "${uri}". The URI may be malformed, invalid, or does not respond with a valid image.`, { name: "EnsAvatarUriResolutionError" });
	}
};
var EnsAvatarUnsupportedNamespaceError = class extends BaseError$1 {
...
async function createAccessList(client, args) {
	...
	try {
		...
		if (response.error) throw new BaseError$1(response.error, { details: response.error });
		return {
...
*/
async function getBlobBaseFee$1(client) {
...
var InvalidTypedDataTypeError = class extends BaseError$1 {
	constructor({ type }) {
...
* })
*/
async function getTransaction$1(client, { blockHash, blockNumber, blockTag: blockTag_, hash, index, sender, nonce }) {
...
async function simulateCalls(client, parameters) {
	...
	if (traceAssetChanges && !account) throw new BaseError$1("`account` is required when `traceAssetChanges` is true");
			...
			const unwatch = poll(async () => {
				...
				try {
					...
					if (filter) logs = await getAction$1(client, getFilterChanges, "getFilterChanges")({ filter });
						...
						if (previousBlockNumber && previousBlockNumber < blockNumber) logs = await getAction$1(client, getContractEvents$1, "getContractEvents")({
							abi,
							address,
							args,
							eventName,
...
* })
*/
async function writeContractSync$1(client, parameters) {
...
async function approveSync(client, parameters) {
	...
	const receipt = await approve.inner(writeContractSync$1, client, {
		...parameters,
		throwOnReceiptRevert
	});
...
async function transferSync(client, parameters) {
	...
	const { decimals } = resolveToken(client, { token });
	const resolved = resolveAmountDecimals(amount, decimals);
	const receipt = await transfer.inner(writeContractSync$1, client, {
		...parameters,
		throwOnReceiptRevert
	});
...
function publicActions(client) {
	return {
		...
		getBlobBaseFee: () => getBlobBaseFee$1(client),
		...
		getContractEvents: (args) => getContractEvents$1(client, args),
...
function walletActions(client) {
	return {
		...
		writeContractSync: (args) => writeContractSync$1(client, args),
		token: {
...
async function getBalance(config, parameters) {
	...
	const client = config.getClient({ chainId });
	const value = await getAction(client, getBalance$2, "getBalance")(blockNumber !== void 0 ? {
		address,
		blockNumber
	} : {
		address,
...
async function getTransactionCount(config, parameters) {
	const { address, blockNumber, blockTag, chainId } = parameters;
	return getAction(config.getClient({ chainId }), getTransactionCount$1, "getTransactionCount")(blockNumber !== void 0 ? {
		address,
		blockNumber
	} : {
		address,
...
async function waitForTransactionReceipt(config, parameters) {
	...
	if (receipt.status === "reverted") throw await withTimeout(async () => {
		...
		errorInstance: /* @__PURE__ */ new Error("unknown reason")
	});
	return {
		...receipt,
		chainId: client.chain.id
...
function createConfig(parameters) {
	...
	if ("3.6.4".startsWith(prefix)) currentVersion = Number.parseInt(version$1.replace(prefix, ""), 10);
	else currentVersion = Number.parseInt("3.6.4".split(".")[0] ?? "0", 10);
...
var BaseError = class extends BaseError$2 {
	constructor() {
		super(...arguments);
...
function getTransactionQueryOptions(config, options = {}) {
	return {
		...options.query,
		enabled: Boolean((options.hash || options.index !== void 0 && (options.blockHash || options.blockNumber || options.blockTag)) && (options.query?.enabled ?? true)),
		queryFn: async (context) => {
			const [, { scopeKey: _, ...parameters }] = context.queryKey;
			if (!(parameters.hash || parameters.index !== void 0 && (parameters.blockHash || parameters.blockNumber || parameters.blockTag))) throw new Error("hash OR index AND blockHash, blockNumber, blockTag is required");
...
//#endregion
//#region node_modules/wagmi/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js
/**
* @license React
...
//#endregion
//#region node_modules/wagmi/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js
/**
* @license React
...
function useDeployContract(parameters = {}) {
	const options = deployContractMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useSendCalls(parameters = {}) {
	const options = sendCallsMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useSendCallsSync(parameters = {}) {
	const options = sendCallsSyncMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useSendTransaction(parameters = {}) {
	const options = sendTransactionMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useSendTransactionSync(parameters = {}) {
	const options = sendTransactionSyncMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useShowCallsStatus(parameters = {}) {
	const options = showCallsStatusMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useSignMessage(parameters = {}) {
	const options = signMessageMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useSignTransaction(parameters = {}) {
	const options = signTransactionMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useSignTypedData(parameters = {}) {
	const options = signTypedDataMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useWatchAsset(parameters = {}) {
	const options = watchAssetMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useWriteContract(parameters = {}) {
	const options = writeContractMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
...
function useWriteContractSync(parameters = {}) {
	const options = writeContractSyncMutationOptions(useConfig(parameters), parameters);
	const mutation = useMutation(options);
	return {
		...mutation,
